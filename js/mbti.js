...
const select = [0, 0, 0, 0]; // variable to save the value for type

function addAnswer(answerText, qIdx, idx) {
    var a = document.querySelector(".aBox");
    var answer = document.createElement("button"); // create button
...
// An animation function which fadeouts main page and show qna page after 450s
function start() {
